...
import { FolderKanban, GalleryVerticalEnd, GitBranch, History, Images, KeyRound, LayoutTemplate, Layers, LogOut, Menu, Package, Settings2, Sparkles, Type, User, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/hero-workflows", label: "AI 工作流", icon: GitBranch },
