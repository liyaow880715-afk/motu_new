...
export function buildSectionPlanningPrompt(
  ...
  return [
    ...
    "- textBudget: keep the default to one headline, one optional subline, at most one badge, and no CTA except conversion sections",
    "",
    "## Rules:",
    ...
    "- Each section must resolve ONE shopper objection with ONE supported claim and ONE visual proof device. Do not combine unrelated selling points.",
    ...
    "- Hero sections should remain recognizable at thumbnail size. Detail sections may carry more evidence, but must still have one dominant conclusion.",
