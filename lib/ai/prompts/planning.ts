...
export function buildSectionPlanningPrompt(
  ...
  return [
    ...
    "Finish every section and close the JSON object before adding any extra wording. Keep title <= 14 Chinese characters, goal <= 28 Chinese characters, copy <= 2 short lines / 70 Chinese characters, and visualPrompt <= 120 Chinese characters.",
    "",
    ...
    "- Output only these fields per section: id, type, title, goal, copy, visualPrompt, visualMode, proofDevice.",
    "- Omit every other field unless absolutely required for a multi-spec section.",
