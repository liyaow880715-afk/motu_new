...
export function buildSectionPlanningPrompt(
  ...
  return [
    ...
    "",
    "## Output format:",
    '{"styleGuide": {"colorPalette": {"background":"#F4EFE6","primary":"#173D2B","secondary":"#E8B23A","accent":"#E95A32","text":"#172019"}, "typography": {"headingStyle":"expressive Chinese commercial display typography","bodyStyle":"clean readable sans-serif","headingFont":"PingFang SC Bold","bodyFont":"PingFang SC Regular"}, "mood":"appetizing, energetic, trustworthy","visualSystem": {"lighting":"directional commercial key light with dimensional highlights","colorTemperature":"consistent warm-neutral grade","exposure":"bright product with protected highlights and readable shadows","contrastLevel":"strong focal contrast with natural material detail","paletteRatio":"background and brand colors remain dominant; accent color may expand where the selling idea needs impact","shadowStyle":"natural dimensional contact shadows","textureStyle":"realistic tactile materials","compositionGrid":"adapt the composition to each selling idea instead of repeating one grid","typographyScale":"headline-led commercial hierarchy with flexible scale contrast","badgeStyle":"only when a verified selling point needs it","iconStyle":"simple category-appropriate graphic language"}}, "sections": [{"id":"...","type":"...","title":"...","goal":"...","copy":"...","mainTitle":"...","subTitle":"...","complianceNote":"...","visualPrompt":"...","visualMode":"poster","headlineAngle":"CORE_BENEFIT","titleDesign":{"layout":"editorial_left","alignment":"left","placement":"upper_left","emphasis":"...","lineBreakAfter":"...","maxLines":2,"panelStyle":"none"},"funnelStage":"attention|interest|trust|decision|conversion","targetShopper":"...","primaryObjection":"...","singleClaim":"...","claimSource":"...","proofDevice":"...","desiredAction":"...","platformProfile":"...","textBudget":{"headlineMaxChars":14,"sublineMaxChars":22,"badgeCount":0,"ctaAllowed":false}}]}',
    "",
    "## Section types:",
